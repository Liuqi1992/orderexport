        ...
        laypage({
            ...
            jump: function(obj, first) {
                ...
                if($("#query_flag").val() === "true") {
                    url = getRoot() + "/doctorTakeStat/query.do?takeDoctorName=" + $("#takeDoctorName").val() + "&year=" + $("#year").val() + "&month=" + $("#month").val() + "&pageNo=" + pageNum;
                } else {
                    url = getRoot() + "/doctorTakeStat/list.do?pageNo=" + pageNum;
                }
                if(!first) {
