        ...
        laypage({
            ...
            jump: function(obj, first) {
                ...
                if($("#query_flag").val() === "true") {
                    url = getRoot() + "/hospitalSaleStat/query.do?hospitalName=" + $("#hospitalName").val() + "&year=" + $("#year").val() + "&month=" + $("#month").val() + "&pageNo=" + pageNum;
                } else {
                    url = getRoot() + "/hospitalSaleStat/list.do?pageNo=" + pageNum;
                }
                if(!first) {
