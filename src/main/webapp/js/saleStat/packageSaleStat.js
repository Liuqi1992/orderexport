        ...
        laypage({
            ...
            jump: function(obj, first) {
                ...
                if($("#query_flag").val() === "true") {
                    url = getRoot() + "/packageSaleStat/query.do?packageName=" + $("#packageName").val() + "&year=" + $("#year").val() + "&month=" + $("#month").val() + "&pageNo=" + pageNum;
                } else {
                    url = getRoot() + "/packageSaleStat/list.do?pageNo=" + pageNum;
                }
                if(!first) {
